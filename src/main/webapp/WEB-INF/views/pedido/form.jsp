...
<script type="text/javascript">
		...
		angular.module("registroPedido").controller("pedidoController", function($scope,$http){
			...
			$scope.registrarPedido = function(pedido){
				...
				$http.post("http://localhost:8080/springhibernate/pedido", pedido).success(function(){
			...
			var cargarPedidos=function(){
				$http.get("http://localhost:8080/springhibernate/pedido").success(function(pedidos){
			...
			<div class="card-panel">
				<div class="row">
					...
					<i class="material-icons prefix">today</i> 
						...
						<label for="descripcion">Fecha de Toma</label>
					</div>
...
<!--Import jQuery before materialize.js-->
	<script type="text/javascript" src="/springhibernate/resourses/jquery.js"></script>
	<script type="text/javascript" src="/springhibernate/resourses/materialize/js/materialize.min.js"></script>
