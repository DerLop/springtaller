...
<script type="text/javascript">
			...
			angular.module("registroUsuario").controller("usuarioController", function($scope,$http){ 
				...
				$scope.registrarUsuario=function(usuario){
					$http.post("http://localhost:8080/springhibernate/usuario", usuario).success(function(){
						delete $scope.usuario;
						cargarUsuario();
				});
			};//fin registroProducto
			var cargarUsuario=function(){
				$http.get("http://localhost:8080/springhibernate/usuario").success(function(usuarios){  
